...
class _MyCustomFormState extends State<MyCustomForm> {
  ...
  bool isNotMarried = false;
  bool isEmployed = false;
  bool isNotEmployed = false;
              ...
              children: [
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    primary: isEmployed ? Colors.blue : Colors.green,
                  ),
                ),
                SizedBox(width: 10),
                ElevatedButton(
                  ...
                  child: Text('No'),
                  style: ElevatedButton.styleFrom(
                    primary: isNotEmployed ? Colors.blue : Colors.green,
                  ),
                ),
              ],
            ),
          ...
          if (isEmployed)
            Padding(
              ...
              child: TextFormField(
                decoration: const InputDecoration(
                  border: UnderlineInputBorder(),
                  labelText: 'Slider Placeholder',
                  //add slider for percent of income from job or flat amount
                ),
              ),
            ),
          Padding(
            ...
            child: Row(
              children: [
                ElevatedButton(
                  ...
                  child: Text('Married'),
                  style: ElevatedButton.styleFrom(
                    primary: isMarried ? Colors.blue : Colors.green,
                  ),
                ),
                SizedBox(width: 10),
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    primary: isNotMarried ? Colors.blue : Colors.green,
                  ),
                ),
              ],
            ),
          ...
          if (isMarried)
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: const InputDecoration(
                  border: UnderlineInputBorder(),
                  labelText: 'Spouse\'s Monthly Income (\$ USD after taxes)',
                ),
              ),
            ),
          Padding(
            ...
            child: TextFormField(
              ...
              decoration: const InputDecoration(
                border: UnderlineInputBorder(),
                labelText: 'Monthly Income (\$ USD after taxes)',
              ),
            ),
          ),
          Padding(
            ...
            child: TextFormField(
              ...
              decoration: const InputDecoration(
                border: UnderlineInputBorder(),
                labelText: 'Monthly Expenses (\$ USD after taxes)',
              ),
            ),
          ),
          Padding(
